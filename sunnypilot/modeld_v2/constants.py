...
class ModelConstants:
  ...
  E2E_TORQUE_OUTPUT_LEN = 1
  E2E_TORQUE_UNCERTAINTY_LEN = 1

  E2E_DIRECT_CONTROL_LEN = 4

  FUSION_RADAR_DIM = 16
  FUSION_MAP_DIM = 16
  FUSION_FEATURE_DIM = 256

  WORLD_MODEL_HORIZON = 5.0
  WORLD_MODEL_DT = 0.1
  WORLD_MODEL_NUM_ROLLOUTS = 8

  DYNAMIC_DELAY_HISTORY_LEN = 100
  DYNAMIC_DELAY_MIN_SPEED = 1.0
  DYNAMIC_DELAY_BASE = 0.15
