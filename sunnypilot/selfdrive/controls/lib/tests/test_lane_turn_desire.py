...
@pytest.mark.parametrize(
  "left_blinker,right_blinker,v_ego,blindspot_left,blindspot_right,expected",
  [
...
class DummyCarState:
  def __init__(
    self, vEgo=0, leftBlinker=False, rightBlinker=False, leftBlindspot=False, rightBlindspot=False, steeringPressed=False, steeringTorque=0, brakePressed=False
  ):
    self.vEgo = vEgo
...
@pytest.mark.parametrize(
  "carstate, lateral_active, lane_change_prob, expected_desire",
  [
    ...
    (
      DummyCarState(vEgo=9, leftBlinker=True, rightBlinker=False, leftBlindspot=False, rightBlindspot=False, steeringPressed=True, steeringTorque=1),
      True,
      1.0,
      log.Desire.laneChangeLeft,
    ),
    (
      DummyCarState(vEgo=9, leftBlinker=False, rightBlinker=True, leftBlindspot=False, rightBlindspot=False, steeringPressed=True, steeringTorque=-1),
      True,
      1.0,
