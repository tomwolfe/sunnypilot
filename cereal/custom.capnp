...
struct ValidationMetrics @0xf74d832e5d1d1d1d {
  ...
  enhanced @11 :EnhancedValidationMetrics;

  struct EnhancedValidationMetrics {
    situationFactor @0 :Float32;
    speedAdjustedConfidence @1 :Float32;
    temporalConsistency @2 :Float32;
    systemSafe @3 :Bool;
    leadConfidenceOk @4 :Bool;
    laneConfidenceOk @5 :Bool;
    overallConfidenceOk @6 :Bool;
    laneChangeSafe @7 :Bool;
    systemEngagementSafe @8 :Bool;
  }
}
