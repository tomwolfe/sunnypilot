...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DisplayAlwaysOn", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DisplayTimeout", {PERSISTENT | BACKUP, INT, "10"}},
    {"AutoBrightness", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"ShowSpeed", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"ShowSpeedLimit", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"ShowETA", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"RainbowMode", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"ShowAdvancedControls", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"ShowTurnSignals", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"StandstillTimer", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TrueVEgoUI", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"UIScale", {PERSISTENT | BACKUP, INT, "100"}},
    ...
    {"LKASEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"CruiseSpeedLimitOffset", {PERSISTENT | BACKUP, INT, "0"}},
    {"CruiseStandStill", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"SmartCruiseEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"AutoLaneChangeEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
