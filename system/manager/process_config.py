...
procs += [
  ...
  # Validation
  PythonProcess("validationd", "selfdrive.common.validation_publisher", only_onroad),
  PythonProcess("validation_controller", "selfdrive.monitoring.validation_controller", only_onroad),
