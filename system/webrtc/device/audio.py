...
# Import aiortc and av libraries conditionally since they're not available on macOS
if platform.system() != "Darwin":
  import av
  if not TYPE_CHECKING:  # Avoid IDE warnings with TYPE_CHECKING
    import aiortc
...
if platform.system() != "Darwin":
  ...
  # Define placeholder classes for macOS where aiortc is not available
