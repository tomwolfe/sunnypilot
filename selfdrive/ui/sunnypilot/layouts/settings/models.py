...
# Constants
DESCRIPTION = "User-settable factor (0.0 to 1.0) to fine-tune model execution performance. Values below 1.0 will throttle model inference frequency. A 0% factor means model inference is effectively stopped, either manually or due to critical overheating."
