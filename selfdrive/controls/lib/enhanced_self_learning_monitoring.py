...
class EnhancedSelfLearningMonitor:
    ...
    def __init__(self):
        ...
        self.computation_times = deque(maxlen=1000)  # Increased buffer for better statistics
...
class EnhancedSafetyValidator:
    ...
    def __init__(self):
        ...
        self.param_validation_history = deque(maxlen=200)  # Increased buffer
        self.safety_check_times = deque(maxlen=100)  # Increased buffer
        self.critical_safety_violations = deque(maxlen=50)  # Track critical violations
    ...
    def validate_with_computational_efficiency(self, params: Dict, v_ego: float) -> Dict:
        ...
        if self.validation_counter % 50 == 0:
            cloudlog.info(f"Safety Validator Stats - Validations: {self.validation_counter}, "
