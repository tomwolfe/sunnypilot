...
def test_safety_manager_initialization():
  ...
  assert safety_manager.safety_engaged
...
def test_steering_safety_monitoring():
  ...
  assert is_safe, "Normal steering should be safe"
...
def test_longitudinal_safety_monitoring():
  ...
  assert is_safe, "Normal longitudinal control should be safe"
...
def test_safety_recommendation():
  ...
  assert recommendation in [log.SelfdriveState.AlertStatus.normal, log.SelfdriveState.AlertStatus.userPrompt, log.SelfdriveState.AlertStatus.critical]
