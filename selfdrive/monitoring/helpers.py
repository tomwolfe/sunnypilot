...
class DriverMonitoring:
  ...
  def _get_distracted_types(self):
    ...
    if (
      pitch_error > (self.settings._POSE_PITCH_THRESHOLD * self.pose.cfactor_pitch if self.pose.calibrated else self.settings._PITCH_NATURAL_THRESHOLD)
      or yaw_error > self.settings._POSE_YAW_THRESHOLD * self.pose.cfactor_yaw
    ):
